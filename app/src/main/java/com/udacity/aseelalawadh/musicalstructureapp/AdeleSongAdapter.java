...
public class AdeleSongAdapter extends ArrayAdapter<AdeleSong> {




    public AdeleSongAdapter(AdeleActivity context, ArrayList<AdeleSong> songs) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AdeleSong currentSong = getItem(position);
