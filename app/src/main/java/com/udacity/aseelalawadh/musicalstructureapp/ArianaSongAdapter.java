...
public class ArianaSongAdapter extends ArrayAdapter<ArianaSong> {


    public ArianaSongAdapter(ArianaActivity context, ArrayList<ArianaSong> songs) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ArianaSong currentSong = getItem(position);
